...
type Props = {
  ...
  onSubmit: (input: VendorBillInput) => void;
  onCancel: () => void;
    ...
    >
      ...
      <div className="space-y-1">
        ...
        <p className="text-xs text-[#6b7280]">
          Selecting a confirmed purchase order loads
          its vendor and line items.
        </p>
      </div>
      ...
      <section>
        ...
        <div className="overflow-x-auto rounded-md border border-[#e5e7eb]">
          <table className="min-w-[720px] w-full text-sm">
                  ...
                  >
                    ...
                    <td className="p-2 text-center">
                      <button
                        ...
                        className="text-[#6b7280] hover:text-red-600 disabled:opacity-30"
                      >
            ...
            <tfoot className="border-t bg-[#f9fafb]">
              <tr>
                <td
                  colSpan={4}
