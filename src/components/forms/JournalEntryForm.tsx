...
const schema = z
  ...
  .refine(
    ...
    {
      message:
        'Debits and credits must balance and be greater than zero.',
      path: ['lines'],
    }
  );
...
export function JournalEntryForm({
  ...
  return (
    ...
    >
      ...
      <div
        className={`grid gap-3 rounded-md p-3 text-sm sm:grid-cols-3 ${
          balanced
      ...
      >
        ...
        <div>
          ...
          {formatCurrency(Math.abs(debit - credit))} ·{' '}
